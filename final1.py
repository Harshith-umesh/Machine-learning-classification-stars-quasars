...
if __name__== "__main__":
 ...
 #Feature importances with extra tree classifier 
...
classifier = BaggingClassifier(DecisionTree(max_depth=7),max_samples=0.7, max_features=0.7)
...
print("\n\n")
print("Mean cross val accuracy:", scores1.mean())
